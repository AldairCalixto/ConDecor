...
import img21 from '../../img/paisaje.png';

const Paisajes = ({ categoria = 'Paisajes' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    Desde serenos mares y playas hasta montañas imponentes, estos cuadros
                                    te transportarán a algunos de los lugares más hermosos del mundo,
                                    ofreciendo una sensación de calma y aventura.
                                </p>
                            </div>
                        </div>
