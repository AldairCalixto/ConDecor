...
import img21 from '../../img/universo.png';

const Universe = ({ categoria = 'Universo' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Universo</h5>
                                ...
                                <p className="card-text">
                                    Explora los misterios del cosmos con cuadros que capturan la inmensidad y
                                    el asombro del universo.
                                </p>
                            </div>
                        </div>
