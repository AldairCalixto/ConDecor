...
import img21 from '../../img/mandelas.png';

const Clasic = ({ categoria = 'Mandela' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Mandelas</h5>
                                ...
                                <p className="card-text">
                                    Tanto obras maestras clásicas como piezas vintage, ideales para aquellos
                                    que aprecian la belleza y el encanto de lo tradicional.
                                </p>
                            </div>
                        </div>
