...
const EdicionLimitada = ({ categoria = 'Edicion Limitada' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Edicion Limitada</h5>
                                ...
                                <p className="card-text">
                                    Explora nuestra colección exclusiva de ediciones limitadas, creadas por artistas digitales de ConDecor. Cada cuadro en tela canvas es único, firmado por el autor y limitado a solo 10 impresiones. Esta exclusividad garantiza un valor especial y una pieza de arte verdaderamente única para tu colección.
                                </p>
                            </div>
                        </div>
