...
import img21 from '../../img/natural.png';

const Natural = ({ categoria = 'Naturaleza' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    Una colección que resalta la riqueza del mundo botánico y la naturaleza, perfecta para traer un toco de vida al interior de tu hogar
                                </p>
                            </div>
                        </div>
