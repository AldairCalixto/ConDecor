...
const Animals = ({ categoria = 'Animales' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Animales</h5>
                                ...
                                <p className="card-text">
                                    Descubre la majestuosidad de aves, caballos, elefantes, leones, y más,
                                    inmortalizados en cuadros que celebran la diversidad de la vida animal.
                                </p>
                            </div>
                        </div>
