...
import img21 from '../../img/noche.png';

const Clasic = ({ categoria = 'Clasicos' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Clasicos</h5>
