...
import img21 from '../../img/elefante.png';

const BlancoYNegro = ({ categoria = 'blanco y negro' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Blanco y Negro</h5>
                                ...
                                <p className="card-text">
                                    Elegantes y sofisticados, estos cuadros utilizan contrastes para crear un
                                    impacto visual poderoso y atemporal.
                                </p>
                            </div>
                        </div>
