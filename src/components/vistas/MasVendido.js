...
const Liquidacion = ({ categoria = 'Mas Vendido' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Lo mas vendido</h5>
                                ...
                                <p className="card-text">
                                    Desde abstractos vibrantes hasta clásicos atemporales, cada pieza está diseñada para destacar. No te pierdas esta oportunidad única de adquirir arte exclusivo a precios irresistibles. ¡Renueva tu hogar con ConDecor y disfruta de grandes descuentos hoy mismo!.
                                </p>
                            </div>
                        </div>
