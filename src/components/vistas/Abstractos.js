...
const Abstractos = ({ categoria = 'abstracto' }) => {
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    Obras que capturan la esencia del color y la forma, perfectas para dar vida
                                    y energía a cualquier habitación.
                                </p>
                            </div>
                        </div>
