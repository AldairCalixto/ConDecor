...
const Personalizado = ({ categoria = 'Personalizado' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
    const [productos, setProductos] = useState([]);
    const [currentPage, setCurrentPage] = useState(1);
    const [productosPerPage] = useState(6); // Número de productos por página
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Personalizados</h5>
                                ...
                                <p className="card-text">
                                    ¡Haz realidad tus ideas con nuestros cuadros personalizados! Envía las imágenes que desees y nosotros nos encargamos del resto. Nos pondremos en contacto contigo para comenzar el proceso de creación de tus cuadros únicos y espectaculares. ¡Transforma tus recuerdos y momentos favoritos en obras de arte excepcionales!.
                                </p>
                            </div>
                        </div>
