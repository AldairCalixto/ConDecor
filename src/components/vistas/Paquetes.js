...
import img21 from '../../img/paquetes.png';

const Paquetes = ({ categoria = 'Paquetes' }) => { // Paso de categoría por props o por defecto 'blanco y negro'
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">PAQUETES ESPECIALES</h5>
                                ...
                                <p className="card-text">
                                    En poco tiempo, nuestros cuadros personalizados se han convertido en una tradición en los hogares
                                    mexicanos. Te presentamos nuestra nueva sección de cuadros a medida. Elige el
                                    paquete que más te guste, realiza tu pago y nos pondremos en contacto contigo para
                                    personalizar tus imágenes.
                                </p>
                            </div>
                        </div>
